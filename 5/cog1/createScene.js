...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		var schulter = scenegraph.createNodeWithModel("Schulter", "sphere", {scale:100});
		schulter.translate([0, 0, 0]);

		var oberarm = scenegraph.createNodeWithModel("01", "cube", {scale:100}, schulter);
		oberarm.translate([0, -450, 0]);
		oberarm.scale([0, 2.5, 0]);

		var ellenbogen = scenegraph.createNodeWithModel("Ellenbogen", "sphere", {scale:100}, schulter);
		ellenbogen.translate([0, -900, 0]);

		var unterarm = scenegraph.createNodeWithModel("Unterarm", "cube", {scale:100}, ellenbogen);
		unterarm.translate([500, 0, 0]);
		unterarm.scale([2.5, 0, 0]);
